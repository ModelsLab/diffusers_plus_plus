...
# https://github.com/showlab/X-Adapter/blob/main/model/adapter.py - 
# not optimized - has a lot of rewritten components - ToDo [optimize and reuse components in the future]

import torch
import torch.nn as nn
from typing import Tuple, Dict, List, OrderedDict
