...
from ..models.embeddings import ImagePositionalEmbeddings, PatchEmbed, PixArtAlphaTextProjection
from ..models.modeling_utils import ModelMixin
from ..models.normalization import AdaLayerNormSingle
...
def HunYuanDiT(ModelMixin, ConfigMixin):
        """
    ...
    self.mlp_t5 = nn.Sequential(
        ...
        SiLU_upcast()
        nn.Linear(self.text_status_dim_T5*4, self.text_states_dim, bias = True)
    )
